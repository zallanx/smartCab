...
class LearningAgent(Agent):
    ...
    def createQ(self, state):
        ...
        if (self.learning == True):
            if state in self.Q:
                print "This state is in Q"
            else:
                #new dictionary for state
                actionDict = {}
                ...
                #print "state to add is ", {state : actionDict}
                #print "New self.Q is ", self.Q
    ...
    def choose_action(self, state):
        ...
        if self.learning == False:
            ...
            # If the random value is below epsilon, choose random action
        ...
        ## TO DO ## 
        ###########
        # When not learning, choose a random action DONE
    ...
    def update(self):
        ...
        self.statesHistory.append(state) #add the last state in an array of all states
